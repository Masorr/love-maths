...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Listening for keydown event, checking if the button is enter
...
function displaySubtractQuestion(operand1, operand2) {
    ...
    /* the ? is a ternary operator, works as an if statement
    parameter, is operand1 > operand 2 ?
    if true for id operand1. then value operand1, else return value operand2
    */
